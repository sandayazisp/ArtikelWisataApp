package id.sandayazisp.artikelwisata
...
import id.sandayazisp.artikelwisata.data.Datasource
import id.sandayazisp.artikelwisata.model.Artikel
import id.sandayazisp.artikelwisata.ui.theme.ArtikelWisataTheme
...
private fun ArtikelCardPreview() {
    ArtikelCard (Artikel(R.string.artikel1, R.drawable.image1))
}